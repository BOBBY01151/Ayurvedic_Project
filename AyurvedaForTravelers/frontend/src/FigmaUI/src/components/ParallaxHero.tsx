  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-0">
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1717657337702-0cf65be367a8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxheXVydmVkaWMlMjBoZXJicyUyMG1lZGl0YXRpb24lMjBwZWFjZWZ1bHxlbnwxfHx8fDE3NTgxMDc5Mjh8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
          alt="Ayurvedic herbs and peaceful meditation"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-br from-[var(--ayurveda-green)]/40 via-[var(--ayurveda-sage)]/30 to-[var(--ayurveda-teal)]/50"></div>
      ...
      <section id="home" className="relative h-screen overflow-hidden z-10">
        <div className="relative z-10 h-full flex items-center justify-center">
          ...
          >
            <Heart className="w-6 h-6 text-[var(--ayurveda-gold)]" />
          </motion.div>
          ...
          <div className="text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
            ...
            >
              ...
              <motion.p
                ...
                className="text-lg md:text-xl text-[var(--ayurveda-gold)] mb-4 font-medium"
              >
          ...
          {/* Scroll Indicator - Scrolls with content */}
          <motion.button
            onClick={scrollToNext}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 1.5 }}
            className="absolute bottom-8 left-1/2 transform -translate-x-1/2 glass-card p-3 rounded-full cursor-pointer hover:scale-110 transition-transform duration-300 z-30"
